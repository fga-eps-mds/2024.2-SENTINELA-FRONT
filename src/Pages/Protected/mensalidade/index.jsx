...
const DataImport = () => {
  const [transactions, setTransactions] = useState([
    {
      name: "joao",
      previousStatus: "Desfiliado",
      currentStatus: "Quitado",
      cpf: "123.456.789-00",
    },
    {
      name: "gabriel flores",
      previousStatus: "Quitado",
      currentStatus: "Desfiliado",
      cpf: "987.654.321-00",
    },
    {
      name: "tiago e ana casal do ano",
  ...
  const pendingTransactions = transactions.filter(
    (transaction) => transaction.currentStatus === "Pendente"
  );
  ...
  return (
    <div className="data-import">
      ...
      {canceledModalVisible && <CanceledModal onClose={closeCanceledModal} />}
