...
const DataImport = () => {
    ...
    const [payedModalVisible, setPayedModalVisible] = useState(false);
    ...
    const openPayedModal = () => {
        setClientModalVisible(false);
        setPayedModalVisible(true);
    };

    const closePayedModal = () => {
        setPayedModalVisible(false);
    };
        ...
        <div className="data-import">
            ...
            {clientModalVisible && (
                <ClientInformationModal
                    ...
                    onQuitado={openPayedModal} // Adicionei essa função para abrir o modal de pagamento
                />
            )}

            {payedModalVisible && (
                <PayedModal
                    onClose={closePayedModal}
                />
            )}
